...
export const HUD: React.FC<HUDProps> = ({ isShop, isBoss }) => {
  ...
  return (
    <>
      <div className="absolute top-0 left-0 w-full p-4 pointer-events-none z-40 flex items-start safe-area-top">
        {/* Top Left: Stats */}
      ...
      {isMobile && (
        <div className="mobile-hud-sector-badge absolute left-0 w-full p-4 pointer-events-none z-40 flex justify-center items-end">

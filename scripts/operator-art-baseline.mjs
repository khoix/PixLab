 ...
 * CAPTURE_SET: weapon-foundation, armor-gate, weapon-family, cuirass, boots, equipment-support; omitted = original baseline.
...
const cases = process.env.CAPTURE_SET === 'equipment-support' ? [
  ['bare', null, null, null],
